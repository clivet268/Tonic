package com.Clivet268.Tonic.TileEntities;
...
public class TileEntityBubbler extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.customName : "container.bubbler";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityBubbler.class, new String[] {"Items"}));
    }
